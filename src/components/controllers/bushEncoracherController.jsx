                ...
                <Slide direction="left" in={this.state.open}>
                    <Card style={styles.root}>
                        <CardContent style={styles.header}>
                            <Typography gutterBottom style={{ fontFamily: 'Lato, Arial, sans-serif', color:'white', fontWeight:'3' }} variant="h5" component="h2">Bush Encroachers</Typography>
                            <Typography variant="body2" color="textSecondary">Visualise our suitability maps and other layers</Typography>
